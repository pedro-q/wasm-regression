...
* @returns {string}
*/
export function analyze_file(buffer) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.analyze_file(retptr, ptr0, len0);
...
* @returns {string}
*/
export function process_file(buffer, data_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.process_file(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred3_0 = r0;
        deferred3_1 = r1;
...
function __wbg_init_memory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:28,maximum:16384,shared:true});
}
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('modelwasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
